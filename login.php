...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("SELECT * FROM users WHERE matric_number = :matric_number");
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" name="matric_number" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter Matric Number or Staff ID" required>
                                        </div>
                                        <div class="form-group">
